...
class StopPow_Melhorn(StopPow):
    __swig_setmethods__ = {}
    for _s in [StopPow]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, StopPow_Melhorn, name, value)
    __swig_getmethods__ = {}
    for _s in [StopPow]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, StopPow_Melhorn, name)
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _StopPow.new_StopPow_Melhorn(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _StopPow.delete_StopPow_Melhorn
    __del__ = lambda self : None;
    def dEdx_MeV_um(self, *args): return _StopPow.StopPow_Melhorn_dEdx_MeV_um(self, *args)
    def dEdx_MeV_mgcm2(self, *args): return _StopPow.StopPow_Melhorn_dEdx_MeV_mgcm2(self, *args)
    def get_Emin(self): return _StopPow.StopPow_Melhorn_get_Emin(self)
    def get_Emax(self): return _StopPow.StopPow_Melhorn_get_Emax(self)
    __swig_setmethods__["mf"] = _StopPow.StopPow_Melhorn_mf_set
    __swig_getmethods__["mf"] = _StopPow.StopPow_Melhorn_mf_get
    if _newclass:mf = _swig_property(_StopPow.StopPow_Melhorn_mf_get, _StopPow.StopPow_Melhorn_mf_set)
    __swig_setmethods__["Zf"] = _StopPow.StopPow_Melhorn_Zf_set
    __swig_getmethods__["Zf"] = _StopPow.StopPow_Melhorn_Zf_get
    if _newclass:Zf = _swig_property(_StopPow.StopPow_Melhorn_Zf_get, _StopPow.StopPow_Melhorn_Zf_set)
    __swig_setmethods__["Zbar"] = _StopPow.StopPow_Melhorn_Zbar_set
    __swig_getmethods__["Zbar"] = _StopPow.StopPow_Melhorn_Zbar_get
    if _newclass:Zbar = _swig_property(_StopPow.StopPow_Melhorn_Zbar_get, _StopPow.StopPow_Melhorn_Zbar_set)
    __swig_setmethods__["nf"] = _StopPow.StopPow_Melhorn_nf_set
    __swig_getmethods__["nf"] = _StopPow.StopPow_Melhorn_nf_get
    if _newclass:nf = _swig_property(_StopPow.StopPow_Melhorn_nf_get, _StopPow.StopPow_Melhorn_nf_set)
    __swig_setmethods__["num"] = _StopPow.StopPow_Melhorn_num_set
    __swig_getmethods__["num"] = _StopPow.StopPow_Melhorn_num_get
    if _newclass:num = _swig_property(_StopPow.StopPow_Melhorn_num_get, _StopPow.StopPow_Melhorn_num_set)
    __swig_setmethods__["rho"] = _StopPow.StopPow_Melhorn_rho_set
    __swig_getmethods__["rho"] = _StopPow.StopPow_Melhorn_rho_get
    if _newclass:rho = _swig_property(_StopPow.StopPow_Melhorn_rho_get, _StopPow.StopPow_Melhorn_rho_set)
    __swig_setmethods__["mt"] = _StopPow.StopPow_Melhorn_mt_set
    __swig_getmethods__["mt"] = _StopPow.StopPow_Melhorn_mt_get
    if _newclass:mt = _swig_property(_StopPow.StopPow_Melhorn_mt_get, _StopPow.StopPow_Melhorn_mt_set)
    __swig_setmethods__["Zt"] = _StopPow.StopPow_Melhorn_Zt_set
    __swig_getmethods__["Zt"] = _StopPow.StopPow_Melhorn_Zt_get
    if _newclass:Zt = _swig_property(_StopPow.StopPow_Melhorn_Zt_get, _StopPow.StopPow_Melhorn_Zt_set)
    __swig_setmethods__["ne"] = _StopPow.StopPow_Melhorn_ne_set
    __swig_getmethods__["ne"] = _StopPow.StopPow_Melhorn_ne_get
    if _newclass:ne = _swig_property(_StopPow.StopPow_Melhorn_ne_get, _StopPow.StopPow_Melhorn_ne_set)
    __swig_setmethods__["Te"] = _StopPow.StopPow_Melhorn_Te_set
    __swig_getmethods__["Te"] = _StopPow.StopPow_Melhorn_Te_get
    if _newclass:Te = _swig_property(_StopPow.StopPow_Melhorn_Te_get, _StopPow.StopPow_Melhorn_Te_set)
    __swig_setmethods__["PlasmaStop"] = _StopPow.StopPow_Melhorn_PlasmaStop_set
    __swig_getmethods__["PlasmaStop"] = _StopPow.StopPow_Melhorn_PlasmaStop_get
    if _newclass:PlasmaStop = _swig_property(_StopPow.StopPow_Melhorn_PlasmaStop_get, _StopPow.StopPow_Melhorn_PlasmaStop_set)
    def dEdx_LSS(self, *args): return _StopPow.StopPow_Melhorn_dEdx_LSS(self, *args)
    def dEdx_nuc(self, *args): return _StopPow.StopPow_Melhorn_dEdx_nuc(self, *args)
    def dEdx_Bethe(self, *args): return _StopPow.StopPow_Melhorn_dEdx_Bethe(self, *args)
    def Ibar(self, *args): return _StopPow.StopPow_Melhorn_Ibar(self, *args)
    def ZtEff(self, *args): return _StopPow.StopPow_Melhorn_ZtEff(self, *args)
    def shell_term(self, *args): return _StopPow.StopPow_Melhorn_shell_term(self, *args)
StopPow_Melhorn_swigregister = _StopPow.StopPow_Melhorn_swigregister
StopPow_Melhorn_swigregister(StopPow_Melhorn)
StopPow_Melhorn.Emin = _StopPow.cvar.StopPow_Melhorn_Emin
StopPow_Melhorn.Emax = _StopPow.cvar.StopPow_Melhorn_Emax
