...
class HohlraumDB_Plot(tk.Toplevel):
    ...
    def __createUI__(self):
        ...
        self.radio1 = ttk.Radiobutton(self, text='Name', variable=self.radio_var, value=0, command=self.__radio_select__)
        self.radio1.grid(row=0, column=0)
        self.radio2 = ttk.Radiobutton(self, text='Drawing', variable=self.radio_var, value=1, command=self.__radio_select__)
        ...
        self.label2 = ttk.Label(self, text='θ min')
        self.label2.grid(row=2, column=0)
        self.theta_min_var = tk.DoubleVar(value=(90-14.6))
        self.theta_min_entry = ttk.Entry(self, textvariable=self.theta_min_var)
        self.theta_min_entry.grid(row=2, column=1)

        self.label3 = ttk.Label(self, text='θ max')
        self.label3.grid(row=3, column=0)
        self.theta_max_var = tk.DoubleVar(value=(90-12.6))
        self.theta_max_entry = ttk.Entry(self, textvariable=self.theta_max_var)
        ...
        self.close_button = ttk.Button(self, text='Close', command=self.withdraw)
